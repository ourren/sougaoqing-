...
<form class="x-sform" method="get" action="list.php" >
<nav class="navbar navbar-inverse " role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a title="最全的高清免费电影" alt="shousibaocai" class="navbar-brand" href="/" >搜高清</a>
        </div>
...
<ul class="pagination">
    <?php
        ...
        ?>
    <li class="<?php echo($disable);?>"><a href="list.php?page=<?php echo($page-1);?>&keyword=<?php echo($distitle);?>">&larr;  Previous</a></li>  
    <?php 
    ...
    ?>
        <li class="<?php echo($disable);?>"><a href="list.php?page=<?php echo($i);?>&keyword=<?php echo($distitle);?>"> <?php echo($i); echo($distag);?> </a></li>

    <?php
        }
        if ($page<$pagenum) { //页数不等于1
            $disable = "";
        }else{$disable = "disabled";}    
    ?>
    <li><a href="list.php?page=<?php echo($page+1);?>&keyword=<?php echo($distitle);?>"> Next &rarr; </a></li>
</ul>
